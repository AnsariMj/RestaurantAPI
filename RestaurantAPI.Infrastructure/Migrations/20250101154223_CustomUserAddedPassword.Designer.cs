...
namespace RestaurantAPI.Infrastructure.Migrations
{
    ...
    [Migration("20250101154223_CustomUserAddedPassword")]
    partial class CustomUserAddedPassword
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RestaurantAPI.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RestaurantAPI.Domain.Entities.Dish", b =>
                {
                    b.HasOne("RestaurantAPI.Domain.Entities.Restaurant", null)
                        .WithMany("Dishes")
            ...
            modelBuilder.Entity("RestaurantAPI.Domain.Entities.Restaurant", b =>
                {
                    b.OwnsOne("RestaurantAPI.Domain.Entities.Address", "Address", b1 =>
                        {
